package com.daniel.mychickenbreastshop.domain.payment.application.kakaopay.webclient;

import com.daniel.mychickenbreastshop.domain.payment.application.kakaopay.error.KakaoPayException;
import com.daniel.mychickenbreastshop.domain.payment.application.kakaopay.webclient.config.KakaoPayClientProperty;
import com.daniel.mychickenbreastshop.domain.payment.application.kakaopay.webclient.model.KakaoPayRequest;
import com.daniel.mychickenbreastshop.domain.payment.application.kakaopay.webclient.model.KakaoPayRequest.OrderInfoRequest;
import com.daniel.mychickenbreastshop.domain.payment.application.kakaopay.webclient.model.KakaoPayRequest.PayApproveRequest;
import com.daniel.mychickenbreastshop.domain.payment.application.kakaopay.webclient.model.KakaoPayRequest.PayCancelRequest;
...
import static com.daniel.mychickenbreastshop.domain.payment.application.kakaopay.webclient.model.KakaoPayProperty.FAILED_POST;
import static com.daniel.mychickenbreastshop.domain.payment.application.kakaopay.webclient.model.KakaoPayResponse.PayApproveResponse;
