package com.daniel.mychickenbreastshop.payment.application.service.gateway.kakaopay.webclient.model;
...
public class KakaoPayResponse {
    ...
    @JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
    @JsonInclude(NON_NULL)
    public static class PayReadyResponse implements PaymentRequestResult {
